...
static const u4_t DEVADDR = 0x000011E2;

static const u1_t PROGMEM DEVEUI[8]={ 0x00, 0x00, 0x06, 0x3A, 0xB4, 0x03, 0x38, 0x99 };
...
void readData(){
  ...
  uint16_t ir, full;
    ...
    delay(100); 
    Wh_int = Wh*100;
    mydata.watt_hour[0] = Wh_int >> 8;
    mydata.watt_hour[1] = Wh_int;
    ...
    oled.setCursor(0,3);
    oled.print(flat,4);oled.print(" ");oled.print(flon,4);oled.print(" ");oled.print(alt*0.01,0);
    oled.setCursor(0,4);
    oled.print("lux:");oled.print(lux_int);oled.print(" Batt:");oled.print(vbat_int*0.01);    
    oled.setCursor(0,5);
    oled.print(V,2);oled.print("V ");oled.print(A,2);oled.print("A ");
    oled.setCursor(0,6);
    oled.print(W,2);oled.print("W ");oled.print(Wh,2);oled.print("Wh ");          
#ifdef DEBUG
    ...
    Serial.print(V);Serial.print("V "); Serial.print(A);Serial.print("A "); Serial.print(W);Serial.println("W ");
    Serial.print(Wh);Serial.print("Whr PF"); Serial.print(PF);Serial.print(" "); Serial.print(F);Serial.println("Hz");
    Serial.println();
#endif   
}
